...
import learn.javafx.mvc.model.Person;
...
public class PersonView extends GridPane {
	...
	private void layoutForm() {
		// Setup the layout pane
		this.setHgap(5);
		this.setVgap(5);

		// Arrange the UI components on the layout pane
	...
	private void bindFieldsToModel() {
		this.personIdFld.textProperty().bind(model.personIdProperty().asString());
